...
@Component({
  selector: 'app-form-campaign-data-anuncio',
  templateUrl: './form-campaign-data-anuncio.component.html',
  styleUrls: ['./form-campaign-data-anuncio.component.scss']
})
export class FormCampaignDataAnuncioComponent implements OnInit {
